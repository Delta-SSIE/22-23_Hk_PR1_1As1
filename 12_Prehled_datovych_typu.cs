...
namespace _12_Prehled_datovych_typu
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            float cenaZaLitrF = 33.5F; // Desetinná čísla ukládáme jako datový typ float
            Console.WriteLine("Za litr nafty dnes zaplatíte " + cenaZaLitrF + "Kč");
